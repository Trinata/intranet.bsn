...
class Trinata
{
	...
	public function buttonUpdate($params)
	{
		if($this->right('update') == 'true')
		{
			...
			return '<a href = "'.$url.'" class = "btn btn-info btn-3d"><i class="px-nav-icon fa fa-pencil"></i></a>';	
		}
	}
	...
	{	
		if($this->right('delete') == 'true')
		{
			...
			return '<a href = "'.$url.'" class = "btn btn-danger btn-3d" onclick = "return confirm(\'Are You sure want to delete this data?\')"><i class="px-nav-icon fa fa-trash"></i></a>';	
		}
	}
	...
	public function buttonView($params)
	{
		if($this->right('view') == 'true')
		{
			...
			return '<a href = "'.$url.'" class = "btn btn-warning btn-3d"><i class="px-nav-icon fa fa-search"></i></a>';	
		}
	}
	...
	public function buttonCreate($params="")
	{
		if($this->right('create') == 'true')
		{
			...
			return '<a href = "'.$url.'" class = "btn btn-info btn-3d"><i class="px-nav-icon fa fa-plus"></i> Add New</a>';
		}
	}
	...
	public function buttonPublish($params,$status = true)
	{
		if($this->right('publish') == 'true')
		{
			...
			$active =  '<a onclick = "return confirm(\'are you sure want to un publish this data ?\')" href = "'.$url.'" class = "btn btn-default btn-3d"><i class="px-nav-icon fa fa-eye"></i></a>';
			$notActive =  '<a onclick = "return confirm(\'are you sure want to  publish this data ?\')" href = "'.$url.'" class = "btn btn-default btn-3d"><i class="px-nav-icon fa fa-eye-slash"></i></a>';
